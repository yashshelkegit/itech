...
const FeatureCard = ({ icon, title, description, delay }) => (
	<motion.div
		className="bg-gradient-to-br from-slate-800 to-gray-700 p-6  rounded-lg shadow-lg text-white"
		initial={{ opacity: 0, y: 50 }}
		animate={{ opacity: 1, y: 0 }}
		transition={{ duration: 0.5, delay }}
		whileHover={{ scale: 1.03, boxShadow: "0 0 20px rgba(123, 31, 162, 0.5)" }}
	>
		<motion.div
